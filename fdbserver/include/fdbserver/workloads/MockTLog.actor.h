...
#if defined(NO_INTELLISENSE) && !defined(FDBSERVER_PTXN_TEST_MockTLog_ACTOR_G_H)
#define FDBSERVER_PTXN_TEST_MockTLog_ACTOR_G_H
#include "fdbserver/workloads/MockTLog.actor.g.h"
#elif !defined(FDBSERVER_PTXN_TEST_MockTLog_ACTOR_H)
#define FDBSERVER_PTXN_TEST_MockTLog_ACTOR_H
...
#endif // FDBSERVER_PTXN_TEST_MockTLog_ACTOR_H
